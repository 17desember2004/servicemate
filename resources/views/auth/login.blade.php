...
.remember{display:flex;align-items:center;gap:8px;font-size:0.85rem;color:#64748b;margin-bottom:22px;}
.remember input[type=checkbox]{width:16px;height:16px;accent-color:#2563eb;}
.btn{width:100%;padding:14px;background:linear-gradient(135deg,#2563eb,#1d4ed8);color:#fff;border:none;border-radius:12px;font-family:inherit;font-weight:700;font-size:1rem;cursor:pointer;transition:opacity .2s,transform .15s;box-shadow:0 4px 16px rgba(37,99,235,0.3);}
...
.alert-error{background:#fef2f2;border:1px solid #fecaca;color:#dc2626;padding:12px 16px;border-radius:10px;font-size:0.85rem;margin-bottom:20px;}
</style>
</head>
<body>
<div class="wrap">
  <div class="card">
    ...
    <p class="sub">Masuk ke akun ServiceMate kamu</p>
    ...
    <p class="register-link">Belum punya akun? <a href="{{ route('register') }}">Daftar gratis</a></p>
    <p class="register-link" style="margin-top:10px"><a href="{{ url('/') }}">← Kembali ke beranda</a></p>
  </div>
</div>
</body>
</html>